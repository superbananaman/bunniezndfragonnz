...
public class OBJLoader {
	public static RawModel loadOBJModel(String filename, Loader loader) {
		...
		try {
			...
			System.out.println("file not found obj loader");
		}
		...
		try {
			...
			while (line != null) {
				...
				processVertex(vertex1, indicies, textures, normals,
						textureArray, normalsArray);
				processVertex(vertex2, indicies, textures, normals,
						textureArray, normalsArray);
				processVertex(vertex3, indicies, textures, normals,
						textureArray, normalsArray);
				line = reader.readLine();
			}
			reader.close();
